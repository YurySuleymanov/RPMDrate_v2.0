for i in $(seq -0.05 0.01 1.02); do
...
echo '    window = Window(xi=xi, kforce=0.0125*T, trajectories=200, equilibrationTime=(20,"ps"), evolutionTime=(100,"ps")) ' >> input"$i".py
...
echo "#$ -N s2OHD32300""$i"" " >> submit"$i".sh                                                                                                             
...
echo "python rpmdrate.py /home/ysuleyma/RPMDrate/Examples/OH2JWGLE2/input"$i".py 300 32 -p 1" >> submit"$i".sh
echo ' ' >> submit"$i".sh
