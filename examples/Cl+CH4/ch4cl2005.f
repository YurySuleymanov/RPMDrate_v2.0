...
C   References:      C. Rangel, M. Navarrete, J.C. Corchado and 
C                    J. Espinosa-Garcia
C                    J.Chem.Phys. 124, 124306 (2006)
C
...
C
       ...
       END DO
C
       REF(1)='J. C. Corchado, D. G. Truhlar, and J. Espinosa-Garcia'
       REF(2)='J. Chem. Phys., Vol. 112, p. 9375, 2000'
C
      INDEXES(1) = 1
      INDEXES(2) = 6
      INDEXES(3) = 1
